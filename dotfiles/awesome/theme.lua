...
theme.fg_focus = "#FFFFFF" -- focused workspace text
theme.fg_urgent = "#FF0000" -- urgent text
theme.fg_minimize = "#000000" -- minimize text (same as inactive workspace text)
...
theme.wallpaper = "/home/gg/nixCore/wallpaper.jpeg"
